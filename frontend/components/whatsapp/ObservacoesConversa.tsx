...
export default function ObservacoesConversa({ conversaId }: { conversaId: string }) {
  ...
  const salvar = async () => {
    ...
    try { await apiClient.salvarNotaConversa(conversaId, texto.trim()); setTexto(''); carregar(); }
  ...
  return (
    <div className="px-4 py-3.5 border-b border-gray-100">
      ...
      <textarea value={texto} onChange={e => setTexto(e.target.value)} rows={3}
        ...
        placeholder="Ex.: Liguei hoje, falou com o dono. Usa o sistema X, reclama do SNGPC. Retornar sexta."
      ...
      <div className="flex items-center justify-between mt-1.5">
        <span className="text-[10px] text-gray-400">Ctrl+Enter salva · vai para o histórico do lead</span>
